...
import ModalPaket3 from "../modal/modalPaket3";
...
const Card3 = () => {
  ...
  const [finalPrice, setFinalPrice] = useState(2500000);
  ...
  const updatePrice = (distance) => {
    ...
    setFinalPrice(2500000 + additionalCost);
  };

  const addCustomerData = async (e) => {
    e.preventDefault();
    const { username, email, location, creditCard, paket, tanggal } =
      inputValue;
  ...
  return (
    <div>
      <div className="card" style={{ backgroundColor: "black" }}>
        <div className="card-footer text-white text-bold">Package 3</div>
        <ul className="list-group list-group-flush">
          <li className="list-group-item">
            Photography + Videography + Kolase
          </li>
          <li className="list-group-item">
