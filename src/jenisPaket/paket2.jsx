        ...
        <div className="container">
            ...
            <div className="row g-5">
                <div className="col-md-7 col-lg-8">
                    ...
                    <h5>- 1 Album 5 Halaman</h5>
                    <h5>- Master Photo Digital</h5>
                    ...
                    <form className="needs-validation" noValidate>
                        <div className="row g-3">
                            ...
                            <div className="col-12">
                                ...
                                <input type="number" className="form-control text-muted" id="harga" name="harga" value={inputValue.harga} readOnly />
                            </div>
                            {/* Credit Card */}
